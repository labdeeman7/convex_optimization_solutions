...
% ISTA 
%==================== 
[fISTA, infoISTA.obj, infoISTA.mse,infoISTA.stopC] = ista(gNoisy(:), F, G, lambda, x0, 1, 5e-4, 200, x(:),@(x) x);
% figure;
...
%==================== 
[fNEST, infoNEST.obj, infoNEST.mse] = fista(gNoisy(:), F, G, lambda, x0, 1, 5e-4, 200, x(:), @(x) x);
% figure;
