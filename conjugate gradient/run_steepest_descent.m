...
% figure, contourf(alpha*X, alpha*Y, log(rosenbrock(alpha*X,alpha*Y))), hold on, plot(infoSteep.xs)
...
[X,Y] = meshgrid(x,y);
Z = rosenbrock(X,Y);
levels = 100:500:10000;
LW = 'linewidth'; FS = 'fontsize'; MS = 'markersize';
figure(1), contour(x,y,Z,levels,LW,0.5),axis([0,3 -2 2]), axis square, hold on, plot(infoSteep.xs), hold off;
figure(2)
